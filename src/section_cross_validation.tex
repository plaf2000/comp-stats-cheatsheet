...
\end{sectionbox}
\begin{sectionbox}[One-standard-error rule]
  Choose the most parsimonious model whose error is no more than one
standard error above the error of the best model.
\end{sectionbox}
